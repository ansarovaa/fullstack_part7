...
const Anecdote = ({anecdotes}) => {
    ...
    return (
        <div>
            ...
            <div>
                <strong>Info: {anecdote.info}</strong>
            </div>
        </div>
    )
}
...
const Footer = () => (
    <div>
        ...
        <a
            href='https://github.com/fullstack-hy/routed-anecdotes/blob/master/src/App.js'>https://github.com/fullstack-hy2019/routed-anecdotes/blob/master/src/App.js</a>
        for the source code.
    </div>
)
...
const App = () => {
    ...
    const vote = (id) => {
        ...
        setAnecdotes(anecdotes.map(a => a.id === id
            ? voted
            : a))
    }
